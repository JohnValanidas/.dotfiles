...
# Note: Pulled from  https://github.com/Sebastiaan76/waybar_wireplumber_audio_changer/tree/main
# adjusted to support rofi
...
rofi_command = f"echo '{output}' | rofi -dmenu --hide-scroll --allow-markup --define=hide_search=true --location=top_right --width=600 --height=200 --xoffset=-60"
